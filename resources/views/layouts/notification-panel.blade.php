...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function getIcon(type) {
        ...
        if (type === 'workspace_deleted') return '<div class="flex items-center justify-center w-9 h-9 rounded-xl bg-red-50 text-red-500 flex-shrink-0"><svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H9.862a2 2 0 01-1.995-1.858L7 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"/></svg></div>';
